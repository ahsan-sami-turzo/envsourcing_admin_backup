                            ...
                            <div class="contactFotter" >
                                <ul class="locF">
                                    <li>
                                        ...
                                        <h4 class="folowUs">Follow us: </h4>
                                        <ul class="social">
                                            <li class="socialMedia" ><a href="https://www.facebook.com/ambalait/" target="__blank"><img src="{{asset('assets/images/s1.png')}}" alt="" height="30px;"></a></li>
                                            <li class="socialMedia"><a href="https://twitter.com/ambala_it?lang=en" target="__blank"><img src="{{asset('assets/images/s2.png')}}" alt="" height="30px;"></a></li>
                                            <li class="socialMedia"><a href="https://www.linkedin.com/company/ambalait/" target="__blank"><img src="{{asset('assets/images/s3.png')}}" alt="" height="30px;"></a></li>
                                        </ul>
                                    </li>
                                    <li class="conLi">
