...
@section('main-page')
    ...
    <div class="panel panel-info ">
        <div class="panel-body">
            ...
            <form enctype="multipart/form-data" name="backGroundForm" id="backGroundForm"
                style="width:20%;background:white;margin-top:2%;">
                ...
                @if ($contactBackGrounds)
                    @foreach ($contactBackGrounds as $contactBackGround)
                        <div class="col-sm-4 col-md-2" style="padding-top:10px;background:#3a768685;">
                            <div class="thumbnail">
                                <img src="{{ asset('public/uploads/images/backgroundImages/') }}/{{ $contactBackGround->backGroundImagePath }}"
                                    alt="5Terre">
                                <div class="caption">
                                    <h3></h3>
                                    <p><a href="#" class="btn btn-danger" role="button"
                                            onclick="delFunction({{ $contactBackGround->id }});">Delete</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="contactInfosId" name="contactInfos" style="padding-left:20px;">
                    <div class="form-group" style="padding-right:2%;">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="countryName" id="countryId"
                                value="{{ $contactInfos->country }}">
                        </div>
                    </div>
                    <div class="form-group" style="padding-right:2%;">
                    ...
                    <div class="form-group" style="padding-right:2%;">
                        ...
                        <div class="col-md-6">
                            <textarea rows="5" class="form-control" name="addressName"
                                id="addressId">{{ $contactInfos->address }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="padding-right:2%;">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="phoneNo" id="phoneNoId"
                                value="{{ $contactInfos->ph }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="padding-right:2%;">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="officeHour" id="officeHourId"
                                value="{{ $contactInfos->timing }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="padding-right:2%;">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="tagline" id="taglineId"
                                value="{{ $contactInfos->mailTag }}">
                        </div>
                    </div>
