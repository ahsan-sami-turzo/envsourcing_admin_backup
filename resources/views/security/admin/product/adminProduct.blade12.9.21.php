          ...
          <div class="panel-body">
              <form id="firstSectionContents" enctype="multipart/form-data" style="background:white;margin-top:2%;" method="POST" action="{{ url('admin/saveProduct') }}" >
                ...
                <div class="form-group">
                  <div class="col-sm-8">
                     <h4> <b>Service</b> </h4>
                     <label><input type="radio" class="serviceType" id="yes" name="yesId" value="1"> Yes </label>
                     <label><input type="radio" class="serviceType" id="no" name="yesId" value="2"> No</label>
               ...
               <div id="serviceInfo"  class="service">
                  <div class="">
                    <div class="">
                      ...
                      <div class="panel panel-default">    
                        <div class="panel-body">
                           <form id="firstSectionContents" enctype="multipart/form-data" style="background:white;margin-top:2%;" method="POST" action="" >
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="row">
                          <div class="form-group" >
                            <div class="col-md-10">
                       ...
                       <div class="row">
                        <div class="form-group" >
                          <div class="col-md-10">
                            ...
                            <textarea class="form-control" rows="10" name="service_desc1" id="editor_service" required></textarea>
                          </div>
                        </div>
                       </div>
